...
AS Answer: the text after and including the second dash was dropped/removed from the new data table.
...
gasol_monthly_hookshots <- gasol_hookshots %>% 
  group_by(month) %>% 
  summarize(monthly_total = sum(month))
